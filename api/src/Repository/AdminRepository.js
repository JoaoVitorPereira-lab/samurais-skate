...
export async function InserirProduto (produto){
    const comando = `INSERT INTO tb_produto  (id_marca, id_categoria, id_tipo, id_tipo_skate, nm_produto, ds_descricao, nr_tamanho, bt_promocao, nr_preco, nr_estoque)
                     VALUES (?,?,?,?,?,?,?,?,?,?)`

    const [resposta] = await con.query(comando, [produto.IdMarca, produto.IdCategoria, produto.IdTipo, produto.IdTipoSkate, produto.nome, produto.descricao, produto.tamanho, produto.promocao, produto.preco, produto.estoque])
