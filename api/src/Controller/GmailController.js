...
server.post('/criarconta-email', (req,resp) => {
    let dados = req.body;
        ...
        <div style="max-width:650px;margin:0 auto">
            <div style="background:#fff;font-size:14pt;color:#686f7a;border-top:4px solid rgb(229, 42, 69);margin-bottom:20px">
                <div style="float:left;font-size:0.8em;border-bottom:1px solid #f2f3f5;padding:20px 20px">
                    <div style="float:left;margin-top:15px;margin-left:15px;color:#E52A45;">
                    ...
                    <div style="font-size:0.8em;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:10px;">
                        ...
                        <div style="color:#000">
                            ...
                            <a style="text-decoration:none;">
                                <b>Nome: <span style="color:#E52A45;"> ${dados.nome} </span> </b>
                            </a>
                            <br/>
                            <a style="text-decoration:none;">
                                <b>Sobrenome: <span style="color:#E52A45;"> ${dados.sobrenome} </span> </b>
                            </a>
                            <br/>
                            <a style="text-decoration:none;">
                                <b>email: <span style="color:#E52A45;"> ${dados.email} </span> </b>
                            </a>
                            <br/>
                            <a style="text-decoration:none;">
                                <b>senha: <span style="color:#E52A45;"> ${dados.senha} </span> </b>
                            </a>
                        </div>
                        <div style="color:#000">
                            <p style="color:#000">
...
server.post('/alterar-email', (req,resp) => {
    let dados = req.body;
    const transport = nodemailer.createTransport({
        host: process.env.HOST,
        port: 587,
            ...
            <div style="background:#fff;font-size:14pt;color:#686f7a;border-top:4px solid rgb(229, 42, 69);margin-bottom:20px">
                ...
                <div style="padding:10px 20px;clear:both">
                    <div style="font-size:0.8em;line-height:1.5em;border-bottom:1px solid #f2f3f5;padding-bottom:10px;margin-bottom:10px;">
                        <p>
                            <a style="text-decoration:none;color:black">
                                <b>Caro usuário ${dados.nome} ${dados.sobrenome}. <br/> Seus dados foram alterados com sucesso. <br/> <br/> Confira como ficaram seus dados abaixo:</b>
                            </a>
                        </p>
                        <div style="color:#000">
                            <a style="text-decoration:none;">
